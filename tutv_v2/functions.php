<?php
include("functions/tutv_func.php");
...
/*-----------------------------------------------------------------------------------*/
	...
	set_post_thumbnail_size( 300, 133, true );
	add_image_size( 'featured', 300, 133, true ); //featured
	add_image_size( 'widgetthumb', 85, 65, true ); //related
	}
