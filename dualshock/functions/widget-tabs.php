...
-----------------------------------------------------------------------------------*/
 function mts_popular_tabs( $posts = 5 ) {
	$arg = array('showposts'=>$post, 'orderby'=>'meta_value_num', 'meta_key'=>'views', 'order'=>'desc');
...
<div class="clear"></div>
    ...
    <div class="meta"><?php echo comments_number(__('0 bình luận','mythemeshop'), __('1 bình luận','mythemeshop'), '<span class="comm">%</span> '.__('bình luận','mythemeshop'));?></div> <!--end .entry-meta--> 	
...
<?php echo $before_widget; ?>
	<div id="tabber">
		...
		<ul class="tabs">
			...
			<li class="tab-recent-posts"><a href="#recent-posts"><?php _e('Bài mới', 'mythemeshop'); ?></a></li>
		</ul> <!--end .tabs-->
