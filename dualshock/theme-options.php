...
$sections[] = array(
	...
	'fields' => array(
		array(
			...
			'sub_desc' => __('Upload your logo <strong>(Recommended size 220x104px)</strong> Use logo PSD provided with this theme, to create your own logo.', 'mythemeshop')
		),
		array(
			'id' => 'mts_favicon',
			'type' => 'upload',
